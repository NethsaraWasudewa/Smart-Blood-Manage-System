...
public class DonorController {
    ...
    private PreparedStatement prepareStatement(String sql) throws SQLException {
        return databaseConnectors.getConnection().prepareStatement(sql);
    }
    ...
    public String[] getDonorDetails(int donorId) {
        ...
        try (Connection conn = databaseConnectors.getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                if (rs.next()) {
                    String dateStr = rs.getDate("last_donation_date") != null ? rs.getDate("last_donation_date").toString() : "No Historical Vector Found";
